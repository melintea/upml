...
idx_transition_t21 == 1
idx_transition_t22 == 2
idx_transition_t32 == 3
idx_transition_t35 == 4
idx_transition_t36 == 5
idx_transition_t43 == 6
idx_transition_t40 == 7
idx_transition_t46 == 8
idx_transition_t33 == 9
idx_transition_t39 == 10
...
variables
    ...
    stateTransitions = { idx_transition_t21, idx_transition_t22, idx_transition_t32, idx_transition_t35, idx_transition_t36, idx_transition_t43, idx_transition_t40, idx_transition_t46, idx_transition_t33, idx_transition_t39 };
    visitedTransitions = [t \in stateTransitions |-> FALSE];
    maxUmlEvents = -5;  \* limit the number of UML events in the run
...
loop_Flip: skip;
    ...
    either {
            ...
            L5:send_event(idx_region_r30, idx_event_LampSwitch, idx_state_Flip, idx_state_Switch); 
            ...
            await (evtRecv = idx_event_NullEvent);
            L6:send_event(idx_region_r30, idx_event_WallSwitch, idx_state_Flip, idx_state_Switch); 

            visitedTransitions[idx_transition_t22] := TRUE;
            newState := idx_state_Flip; 
            goto body_Flip;
...
progress_BothOff: skip;
    ...
    either {
            ...
            visitedTransitions[idx_transition_t32] := TRUE;
            ...
            visitedTransitions[idx_transition_t35] := TRUE;
...
progress_LampOff: skip;
    ...
    either {
            ...
            visitedTransitions[idx_transition_t36] := TRUE;
...
progress_On: skip;
    ...
    either {
            ...
            visitedTransitions[idx_transition_t40] := TRUE;
            newState := idx_state_WallOff; 
            goto entry_WallOff;
...
progress_WallOff: skip;
    ...
    either {
            ...
            visitedTransitions[idx_transition_t33] := TRUE;
            newState := idx_state_BothOff; 
            goto entry_BothOff;
            ...
            visitedTransitions[idx_transition_t39] := TRUE;
            newState := idx_state_On; 
            goto entry_On;
...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "5d0e6fab" /\ chksum(tla) = "b799d799")
\* Process variable evtRecv of process region_r17 at line 136 col 5 changed to evtRecv_
\* Process variable initialState of process region_r17 at line 137 col 5 changed to initialState_
\* Process variable finalState of process region_r17 at line 138 col 5 changed to finalState_
\* Process variable newState of process region_r17 at line 139 col 5 changed to newState_
\* Process variable noChannel of process region_r17 at line 140 col 5 changed to noChannel_
\* Process variable evtRecv of process region_r19 at line 182 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r19 at line 183 col 5 changed to initialState_r
\* Process variable finalState of process region_r19 at line 184 col 5 changed to finalState_r
\* Process variable newState of process region_r19 at line 185 col 5 changed to newState_r
\* Process variable noChannel of process region_r19 at line 186 col 5 changed to noChannel_r
...
L6(self) == /\ pc[self] = "L6"
            ...
            /\ maxUmlEvents' = maxUmlEvents + 1
            /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t22] = TRUE]
            /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_Flip]
            /\ pc' = [pc EXCEPT ![self] = "body_Flip"]
            /\ UNCHANGED << procs, currentState, stateTransitions, evtRecv_, 
                            initialState_, finalState_, newState_, noChannel_, 
...
L8(self) == /\ pc[self] = "L8"
            /\ \/ /\ (evtRecv[self] = idx_event_LampSwitch)
                  /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t32] = TRUE]
                  /\ newState' = [newState EXCEPT ![self] = idx_state_WallOff]
                  /\ pc' = [pc EXCEPT ![self] = "entry_WallOff"]
               \/ /\ (evtRecv[self] = idx_event_WallSwitch)
                  /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t35] = TRUE]
...
L10(self) == /\ pc[self] = "L10"
             /\ \/ /\ (evtRecv[self] = idx_event_WallSwitch)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t36] = TRUE]
...
L12(self) == /\ pc[self] = "L12"
             /\ \/ /\ (evtRecv[self] = idx_event_LampSwitch)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t40] = TRUE]
                   /\ newState' = [newState EXCEPT ![self] = idx_state_WallOff]
                   /\ pc' = [pc EXCEPT ![self] = "entry_WallOff"]
                \/ /\ (evtRecv[self] = idx_event_WallSwitch)
...
L14(self) == /\ pc[self] = "L14"
             /\ \/ /\ (evtRecv[self] = idx_event_LampSwitch)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t33] = TRUE]
                   /\ newState' = [newState EXCEPT ![self] = idx_state_BothOff]
                   /\ pc' = [pc EXCEPT ![self] = "entry_BothOff"]
                \/ /\ (evtRecv[self] = idx_event_WallSwitch)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t39] = TRUE]
                   /\ newState' = [newState EXCEPT ![self] = idx_state_On]
                   /\ pc' = [pc EXCEPT ![self] = "entry_On"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             maxUmlEvents, evtRecv_, initialState_, 
