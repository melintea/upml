...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "79775805" /\ chksum(tla) = "a4daa5f1")
\* Process variable evtRecv of process region_r17 at line 107 col 5 changed to evtRecv_
\* Process variable initialState of process region_r17 at line 108 col 5 changed to initialState_
\* Process variable finalState of process region_r17 at line 109 col 5 changed to finalState_
...
\* Process variable newState of process region_r19 at line 156 col 5 changed to newState_r
\* Process variable noChannel of process region_r19 at line 157 col 5 changed to noChannel_r
...
entry_Flip(self) == /\ pc[self] = "entry_Flip"
                    ...
                    /\ UNCHANGED << procs, channels, evtRecv_, initialState_, 
                                    ...
                                    newState_r, evtRecv, initialState, 
                                    finalState, newState, noChannel >>
...
L5(self) == /\ pc[self] = "L5"
            ...
            /\ UNCHANGED << procs, currentState, evtRecv_, initialState_, 
                            ...
                            initialState_r, finalState_r, noChannel_r, evtRecv, 
                            initialState, finalState, newState, noChannel >>
...
L7(self) == /\ pc[self] = "L7"
            ...
            /\ UNCHANGED << procs, currentState, evtRecv_, initialState_, 
                            finalState_, newState_, noChannel_, evtRecv_r, 
                            initialState_r, finalState_r, newState_r, 
                            noChannel_r, initialState, finalState, newState, 
                            noChannel >>
