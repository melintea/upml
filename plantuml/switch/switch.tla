...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "38f3b869" /\ chksum(tla) = "8771a9ab")
\* Process variable evtRecv of process region_r17 at line 108 col 5 changed to evtRecv_
\* Process variable initialState of process region_r17 at line 109 col 5 changed to initialState_
\* Process variable finalState of process region_r17 at line 110 col 5 changed to finalState_
\* Process variable currentState of process region_r17 at line 111 col 5 changed to currentState_
\* Process variable newState of process region_r17 at line 112 col 5 changed to newState_
\* Process variable noChannel of process region_r17 at line 113 col 5 changed to noChannel_
\* Process variable evtRecv of process region_r19 at line 155 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r19 at line 156 col 5 changed to initialState_r
\* Process variable finalState of process region_r19 at line 157 col 5 changed to finalState_r
\* Process variable currentState of process region_r19 at line 158 col 5 changed to currentState_r
\* Process variable newState of process region_r19 at line 159 col 5 changed to newState_r
\* Process variable noChannel of process region_r19 at line 160 col 5 changed to noChannel_r
VARIABLES channels, maxe, pc, evtRecv_, initialState_, finalState_, 
          currentState_, newState_, noChannel_, evtRecv_r, initialState_r, 
          finalState_r, currentState_r, newState_r, noChannel_r, evtRecv, 
          initialState, finalState, currentState, newState, noChannel

vars == << channels, maxe, pc, evtRecv_, initialState_, finalState_, 
           currentState_, newState_, noChannel_, evtRecv_r, initialState_r, 
           finalState_r, currentState_r, newState_r, noChannel_r, evtRecv, 
           initialState, finalState, currentState, newState, noChannel >>
...
proc_body_idx_region_r17(self) == /\ pc[self] = "proc_body_idx_region_r17"
                                  ...
                                  /\ UNCHANGED << channels, maxe, evtRecv_, 
...
entry_Human(self) == /\ pc[self] = "entry_Human"
                     ...
                     /\ UNCHANGED << channels, maxe, evtRecv_, initialState_, 
...
body_Human(self) == /\ pc[self] = "body_Human"
                    ...
                    /\ UNCHANGED << channels, maxe, initialState_, finalState_, 
...
R1(self) == /\ pc[self] = "R1"
            ...
            /\ pc' = [pc EXCEPT ![self] = "entry_Switch"]
            /\ UNCHANGED << maxe, initialState_, finalState_, currentState_, 
...
body_Switch(self) == /\ pc[self] = "body_Switch"
                     ...
                     /\ UNCHANGED << channels, maxe, initialState_, 
...
R3(self) == /\ pc[self] = "R3"
            ...
            /\ channels' = [channels EXCEPT ![self] = Tail(@)]
            /\ pc' = [pc EXCEPT ![self] = "T4"]
            /\ UNCHANGED << maxe, evtRecv_, initialState_, finalState_, 
                            currentState_, newState_, noChannel_, 
...
T4(self) == /\ pc[self] = "T4"
            ...
            /\ UNCHANGED << channels, maxe, evtRecv_, initialState_, 
                            finalState_, currentState_, newState_, noChannel_, 
                            evtRecv_r, initialState_r, finalState_r, 
                            currentState_r, newState_r, noChannel_r, evtRecv, 
                            initialState, finalState, currentState, newState, 
                            noChannel >>
...
S5(self) == /\ pc[self] = "S5"
            ...
            /\ PrintT(<<"maxe:", maxe'>>)
            /\ IF maxe' >= 0
                  THEN /\ pc' = [pc EXCEPT ![self] = "end_Proc"]
                  ELSE /\ pc' = [pc EXCEPT ![self] = "X"]
...
X(self) == /\ pc[self] = "X"
           ...
           /\ UNCHANGED << channels, maxe, evtRecv_, initialState_, 
                           finalState_, currentState_, newState_, noChannel_, 
                           evtRecv_r, initialState_r, finalState_r, 
                           currentState_r, noChannel_r, evtRecv, initialState, 
                           finalState, currentState, newState, noChannel >>
...
end_Proc(self) == /\ pc[self] = "end_Proc"
                  /\ TRUE
                  /\ pc' = [pc EXCEPT ![self] = "Done"]
                  /\ UNCHANGED << channels, maxe, evtRecv_, initialState_, 
                                  finalState_, currentState_, newState_, 
...
region_r19(self) == proc_body_idx_region_r19(self) \/ entry_Flip(self)
                       ...
                       \/ T4(self) \/ S5(self) \/ X(self) \/ S6(self)
                       \/ Y(self) \/ end_Proc(self)
...
T8(self) == /\ pc[self] = "T8"
            ...
            /\ UNCHANGED << channels, maxe, evtRecv_, initialState_, 
                            ...
                            evtRecv_r, initialState_r, finalState_r, 
                            currentState_r, newState_r, noChannel_r, evtRecv, 
                            initialState, finalState, currentState, noChannel >>
