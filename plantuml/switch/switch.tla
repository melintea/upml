...
loop_Flip: skip;    
    ...
    either {    
        ...
        \*     (F:'';L:0;C:0) idx_state_Flip:send: send,event:LampSwitch,to,state:Switch, (a21)
        ...
        \*     (F:'';L:22;C:1) Flip --> Flip NullEvent[]/send,event:WallSwitch,to,state:Switch, (t22)
        await (evtRecv = idx_event_NullEvent);
        \*     (F:'';L:0;C:0) idx_state_Flip:send: send,event:WallSwitch,to,state:Switch, (a22)
...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "2ca40dc0" /\ chksum(tla) = "d9777c10")
\* Process variable evtRecv of process region_r17 at line 128 col 5 changed to evtRecv_
\* Process variable initialState of process region_r17 at line 129 col 5 changed to initialState_
\* Process variable finalState of process region_r17 at line 130 col 5 changed to finalState_
\* Process variable newState of process region_r17 at line 131 col 5 changed to newState_
\* Process variable noChannel of process region_r17 at line 132 col 5 changed to noChannel_
\* Process variable evtRecv of process region_r19 at line 176 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r19 at line 177 col 5 changed to initialState_r
\* Process variable finalState of process region_r19 at line 178 col 5 changed to finalState_r
\* Process variable newState of process region_r19 at line 179 col 5 changed to newState_r
\* Process variable noChannel of process region_r19 at line 180 col 5 changed to noChannel_r
