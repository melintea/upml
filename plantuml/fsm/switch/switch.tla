/*
/home/amelinte/work/github/upml/src/upml --in /home/amelinte/work/github/upml/plantuml/fsm/switch/switch.plantuml --backend tla-fsm --out ../plantuml/fsm/switch/switch.tla 
*/
/*
   Generated by UPML v0.10
   Thu May 28 19:20:01 2026
...
idx_region_HumanINr19 == 1
idx_region_SwitchINr37 == 2
idx_region_m1INr17 == 3
...
variables
    ...
    procs = { idx_region_HumanINr19, idx_region_SwitchINr37, idx_region_m1INr17 };
    channels = [p \in procs |-> <<>>];
...
fair+ process (region_m1INr17 \in {idx_region_m1INr17}) \* switch
variables
    evtRecv = idx_Unknown; 
...
{
proc_body_idx_region_m1INr17: currentState[self] := initialState;
...
fair+ process (region_HumanINr19 \in {idx_region_HumanINr19}) \* Human
variables
    evtRecv = idx_Unknown; 
...
{
proc_body_idx_region_HumanINr19: currentState[self] := initialState;
...
loop_TurnLightOn: skip;    
    ...
    either {    
        ...
        L5:send_event(idx_region_SwitchINr37, idx_event_LampSwitch, idx_state_TurnLightOn, idx_state_Switch); 
        L6:send_event(idx_region_SwitchINr37, idx_event_WallSwitch, idx_state_TurnLightOn, idx_state_Switch); 
        ...
        L7:send_event(idx_region_SwitchINr37, idx_event_WallSwitch, idx_state_TurnLightOn, idx_state_Switch); 
        L8:send_event(idx_region_SwitchINr37, idx_event_LampSwitch, idx_state_TurnLightOn, idx_state_Switch); 
...
body_TurnLightOff: skip;    
    ...
    either {    
        ...
        L11:send_event(idx_region_SwitchINr37, idx_event_LampSwitch, idx_state_TurnLightOff, idx_state_Switch); 
        L12:send_event(idx_region_SwitchINr37, idx_event_WallSwitch, idx_state_TurnLightOff, idx_state_Switch); 
        ...
        L13:send_event(idx_region_SwitchINr37, idx_event_WallSwitch, idx_state_TurnLightOff, idx_state_Switch); 
        L14:send_event(idx_region_SwitchINr37, idx_event_LampSwitch, idx_state_TurnLightOff, idx_state_Switch); 
...
fair+ process (region_SwitchINr37 \in {idx_region_SwitchINr37}) \* Switch
variables
    evtRecv = idx_Unknown; 
...
{
proc_body_idx_region_SwitchINr37: currentState[self] := initialState;
...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "6d18de28" /\ chksum(tla) = "52ec88a9")
\* Process variable evtRecv of process region_m1INr17 at line 147 col 5 changed to evtRecv_
\* Process variable initialState of process region_m1INr17 at line 148 col 5 changed to initialState_
\* Process variable finalState of process region_m1INr17 at line 149 col 5 changed to finalState_
\* Process variable newState of process region_m1INr17 at line 150 col 5 changed to newState_
\* Process variable noChannel of process region_m1INr17 at line 151 col 5 changed to noChannel_
\* Process variable evtRecv of process region_HumanINr19 at line 196 col 5 changed to evtRecv_r
\* Process variable initialState of process region_HumanINr19 at line 197 col 5 changed to initialState_r
\* Process variable finalState of process region_HumanINr19 at line 198 col 5 changed to finalState_r
\* Process variable newState of process region_HumanINr19 at line 199 col 5 changed to newState_r
\* Process variable noChannel of process region_HumanINr19 at line 200 col 5 changed to noChannel_r
...
ProcSet == ({idx_region_m1INr17}) \cup ({idx_region_HumanINr19}) \cup ({idx_region_SwitchINr37})
...
Init == (* Global variables *)
        ...
        /\ visitedTransitions = [t \in stateTransitions |-> FALSE]
        /\ maxUmlEvents = -20
        (* Process region_m1INr17 *)
        /\ evtRecv_ = [self \in {idx_region_m1INr17} |-> idx_Unknown]
        /\ initialState_ = [self \in {idx_region_m1INr17} |-> idx_Unknown]
        /\ finalState_ = [self \in {idx_region_m1INr17} |-> idx_Unknown]
        /\ newState_ = [self \in {idx_region_m1INr17} |-> initialState_[self]]
        /\ noChannel_ = [self \in {idx_region_m1INr17} |-> FALSE]
        (* Process region_HumanINr19 *)
        /\ evtRecv_r = [self \in {idx_region_HumanINr19} |-> idx_Unknown]
        /\ initialState_r = [self \in {idx_region_HumanINr19} |-> idx_state_TurnLightOn]
        /\ finalState_r = [self \in {idx_region_HumanINr19} |-> idx_state_Done]
        /\ newState_r = [self \in {idx_region_HumanINr19} |-> initialState_r[self]]
        /\ noChannel_r = [self \in {idx_region_HumanINr19} |-> FALSE]
        (* Process region_SwitchINr37 *)
        /\ evtRecv = [self \in {idx_region_SwitchINr37} |-> idx_Unknown]
        /\ initialState = [self \in {idx_region_SwitchINr37} |-> idx_state_BothOff]
        /\ finalState = [self \in {idx_region_SwitchINr37} |-> idx_state_BothOff]
        /\ newState = [self \in {idx_region_SwitchINr37} |-> initialState[self]]
        /\ noChannel = [self \in {idx_region_SwitchINr37} |-> FALSE]
        /\ pc = [self \in ProcSet |-> CASE self \in {idx_region_m1INr17} -> "proc_body_idx_region_m1INr17"
                                        [] self \in {idx_region_HumanINr19} -> "proc_body_idx_region_HumanINr19"
                                        [] self \in {idx_region_SwitchINr37} -> "proc_body_idx_region_SwitchINr37"]

proc_body_idx_region_m1INr17(self) == /\ pc[self] = "proc_body_idx_region_m1INr17"
...
region_m1INr17(self) == proc_body_idx_region_m1INr17(self)
                           \/ entry_Human(self) \/ body_Human(self)
                           \/ L1(self) \/ entry_Switch(self)
                           \/ body_Switch(self) \/ L2(self)

proc_body_idx_region_HumanINr19(self) == /\ pc[self] = "proc_body_idx_region_HumanINr19"
...
L5(self) == /\ pc[self] = "L5"
            /\ PrintT(<<"P:", idx_state_TurnLightOn, "o->", idx_event_LampSwitch, idx_region_SwitchINr37, " > P:", idx_state_Switch>>)
            /\ channels' = [channels EXCEPT ![idx_region_SwitchINr37] = Append(@, idx_event_LampSwitch)]
            /\ maxUmlEvents' = maxUmlEvents + 1
...
L6(self) == /\ pc[self] = "L6"
            /\ PrintT(<<"P:", idx_state_TurnLightOn, "o->", idx_event_WallSwitch, idx_region_SwitchINr37, " > P:", idx_state_Switch>>)
            /\ channels' = [channels EXCEPT ![idx_region_SwitchINr37] = Append(@, idx_event_WallSwitch)]
            /\ maxUmlEvents' = maxUmlEvents + 1
...
L11(self) == /\ pc[self] = "L11"
             /\ PrintT(<<"P:", idx_state_TurnLightOff, "o->", idx_event_LampSwitch, idx_region_SwitchINr37, " > P:", idx_state_Switch>>)
             /\ channels' = [channels EXCEPT ![idx_region_SwitchINr37] = Append(@, idx_event_LampSwitch)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
L12(self) == /\ pc[self] = "L12"
             /\ PrintT(<<"P:", idx_state_TurnLightOff, "o->", idx_event_WallSwitch, idx_region_SwitchINr37, " > P:", idx_state_Switch>>)
             /\ channels' = [channels EXCEPT ![idx_region_SwitchINr37] = Append(@, idx_event_WallSwitch)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
region_HumanINr19(self) == proc_body_idx_region_HumanINr19(self)
                              \/ entry_TurnLightOn(self)
                              \/ body_TurnLightOn(self)
                              \/ loop_TurnLightOn(self) \/ L3(self)
                              \/ L4(self) \/ L5(self) \/ L6(self)
                              \/ L7(self) \/ L8(self)
                              \/ entry_TurnLightOff(self)
                              \/ body_TurnLightOff(self) \/ L9(self)
                              \/ L10(self) \/ L11(self) \/ L12(self)
                              \/ L13(self) \/ L14(self) \/ entry_Done(self)
                              \/ body_Done(self) \/ loop_Done(self)
                              \/ end_Done(self) \/ L15(self)

proc_body_idx_region_SwitchINr37(self) == /\ pc[self] = "proc_body_idx_region_SwitchINr37"
...
region_SwitchINr37(self) == proc_body_idx_region_SwitchINr37(self)
                               \/ entry_BothOff(self) \/ body_BothOff(self)
                               \/ loop_BothOff(self)
                               \/ progress_BothOff(self)
                               \/ end_BothOff(self) \/ L16(self)
                               \/ L17(self) \/ entry_LampOff(self)
                               \/ body_LampOff(self)
                               \/ progress_LampOff(self) \/ L18(self)
                               \/ L19(self) \/ entry_On(self)
                               \/ body_On(self) \/ progress_On(self)
                               \/ L20(self) \/ L21(self)
                               \/ entry_WallOff(self) \/ body_WallOff(self)
                               \/ progress_WallOff(self) \/ L22(self)
                               \/ L23(self)
...
Next == (\E self \in {idx_region_m1INr17}: region_m1INr17(self))
           \/ (\E self \in {idx_region_HumanINr19}: region_HumanINr19(self))
           \/ (\E self \in {idx_region_SwitchINr37}: region_SwitchINr37(self))
           \/ Terminating

Spec == /\ Init /\ [][Next]_vars
        /\ \A self \in {idx_region_m1INr17} : SF_vars(region_m1INr17(self))
        /\ \A self \in {idx_region_HumanINr19} : SF_vars(region_HumanINr19(self))
        /\ \A self \in {idx_region_SwitchINr37} : SF_vars(region_SwitchINr37(self))
...
\*     (F:'';L:30;C:1) Human:ltl: ltlLight,{,<>,[],(,state:Switch:currentState,==,state:BothOff,&&,lightOn,==,false,),->,(,state:Switch:currentState,==,state:On,&&,lightOn,==,true,),->,(,state:Switch:currentState,==,state:BothOff,&&,lightOn,==,false,&&,state:Human:currentState,==,state:Done,),}, (a30)
ltlLight == <> [] ( currentState[idx_region_SwitchINr37]  = idx_state_BothOff /\ lightOn = FALSE ) -> ( currentState[idx_region_SwitchINr37]  = idx_state_On /\ lightOn = TRUE ) -> ( currentState[idx_region_SwitchINr37]  = idx_state_BothOff /\ lightOn = FALSE /\ currentState[idx_region_HumanINr19]  = idx_state_Done ) 
