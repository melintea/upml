...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "a2f04f61" /\ chksum(tla) = "8dc27eb6")
\* Process variable evtRecv of process region_r3 at line 185 col 5 changed to evtRecv_
\* Process variable initialState of process region_r3 at line 186 col 5 changed to initialState_
\* Process variable finalState of process region_r3 at line 187 col 5 changed to finalState_
\* Process variable newState of process region_r3 at line 188 col 5 changed to newState_
\* Process variable noChannel of process region_r3 at line 189 col 5 changed to noChannel_
\* Process variable evtRecv of process region_r22 at line 251 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r22 at line 252 col 5 changed to initialState_r
\* Process variable finalState of process region_r22 at line 253 col 5 changed to finalState_r
\* Process variable newState of process region_r22 at line 254 col 5 changed to newState_r
\* Process variable noChannel of process region_r22 at line 255 col 5 changed to noChannel_r
\* Process variable evtRecv of process region_r44 at line 414 col 5 changed to evtRecv_re
\* Process variable initialState of process region_r44 at line 415 col 5 changed to initialState_re
\* Process variable finalState of process region_r44 at line 416 col 5 changed to finalState_re
\* Process variable newState of process region_r44 at line 417 col 5 changed to newState_re
\* Process variable noChannel of process region_r44 at line 418 col 5 changed to noChannel_re
...
L9(self) == /\ pc[self] = "L9"
            /\ Assert(((currentState[idx_region_r22] /=idx_state_BIdle)), 
                      "Failure of assertion at line 331, column 9.")
...
L13(self) == /\ pc[self] = "L13"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 355, column 14.")
             /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_AInitiated]
             /\ pc' = [pc EXCEPT ![self] = "body_AInitiated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
...
L14(self) == /\ pc[self] = "L14"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 368, column 14.")
...
L16(self) == /\ pc[self] = "L16"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 382, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Aterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
L24(self) == /\ pc[self] = "L24"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AIdle)), 
                       "Failure of assertion at line 503, column 10.")
...
L28(self) == /\ pc[self] = "L28"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 527, column 14.")
             /\ newState_re' = [newState_re EXCEPT ![self] = idx_state_BEstablished]
...
L30(self) == /\ pc[self] = "L30"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 541, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Bterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
