...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "405b2558" /\ chksum(tla) = "8b06dcda")
\* Process variable evtRecv of process region_r3 at line 160 col 5 changed to evtRecv_
\* Process variable initialState of process region_r3 at line 161 col 5 changed to initialState_
\* Process variable finalState of process region_r3 at line 162 col 5 changed to finalState_
...
\* Process variable newState of process region_r20 at line 226 col 5 changed to newState_r
\* Process variable noChannel of process region_r20 at line 227 col 5 changed to noChannel_r
\* Process variable evtRecv of process region_r42 at line 382 col 5 changed to evtRecv_re
\* Process variable initialState of process region_r42 at line 383 col 5 changed to initialState_re
\* Process variable finalState of process region_r42 at line 384 col 5 changed to finalState_re
\* Process variable newState of process region_r42 at line 385 col 5 changed to newState_re
\* Process variable noChannel of process region_r42 at line 386 col 5 changed to noChannel_re
VARIABLES procs, channels, currentState, pc, evtRecv_, initialState_, 
...
vars == << procs, channels, currentState, pc, evtRecv_, initialState_, 
           finalState_, newState_, noChannel_, evtRecv_r, initialState_r, 
           finalState_r, newState_r, noChannel_r, evtRecv_re, initialState_re, 
           finalState_re, newState_re, noChannel_re, evtRecv, initialState, 
           finalState, newState, noChannel >>
...
proc_body_idx_region_r3(self) == /\ pc[self] = "proc_body_idx_region_r3"
                                 ...
                                 /\ UNCHANGED << procs, channels, evtRecv_, 
...
entry_Alice(self) == /\ pc[self] = "entry_Alice"
                     ...
                     /\ UNCHANGED << procs, channels, evtRecv_, initialState_, 
...
L1(self) == /\ pc[self] = "L1"
            ...
            /\ pc' = [pc EXCEPT ![self] = "entry_Bob"]
            /\ UNCHANGED << procs, currentState, initialState_, finalState_, 
                            newState_, noChannel_, evtRecv_r, initialState_r, 
                            finalState_r, newState_r, noChannel_r, evtRecv_re, 
...
body_Bob(self) == /\ pc[self] = "body_Bob"
                  ...
                  /\ UNCHANGED << procs, channels, currentState, initialState_, 
...
body_AIdle(self) == /\ pc[self] = "body_AIdle"
                    ...
                    /\ UNCHANGED << procs, channels, currentState, evtRecv_, 
                                    initialState_, finalState_, newState_, 
                                    noChannel_, evtRecv_r, initialState_r, 
                                    finalState_r, newState_r, noChannel_r, 
                                    evtRecv_re, initialState_re, finalState_re, 
...
L4(self) == /\ pc[self] = "L4"
            ...
            /\ channels' = [channels EXCEPT ![self] = Tail(@)]
            /\ pc' = [pc EXCEPT ![self] = "L5"]
            /\ UNCHANGED << procs, currentState, evtRecv_, initialState_, 
                            finalState_, newState_, noChannel_, initialState_r, 
                            finalState_r, newState_r, noChannel_r, evtRecv_re, 
                            initialState_re, finalState_re, newState_re, 
                            noChannel_re, evtRecv, initialState, finalState, 
                            newState, noChannel >>
...
L9(self) == /\ pc[self] = "L9"
            /\ Assert(((currentState[idx_region_r20] /=idx_state_BIdle)), 
                      "Failure of assertion at line 300, column 13.")
...
body_AInitiated(self) == /\ pc[self] = "body_AInitiated"
                         ...
                         /\ UNCHANGED << procs, channels, currentState, 
                                         ...
                                         newState_, noChannel_, initialState_r, 
                                         finalState_r, newState_r, noChannel_r, 
                                         evtRecv_re, initialState_re, 
                                         finalState_re, newState_re, 
                                         noChannel_re, evtRecv, initialState, 
...
L13(self) == /\ pc[self] = "L13"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 324, column 14.")
             /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_AInitiated]
             /\ pc' = [pc EXCEPT ![self] = "body_AInitiated"]
             /\ UNCHANGED << procs, channels, currentState, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
L14(self) == /\ pc[self] = "L14"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 336, column 14.")
...
L15(self) == /\ pc[self] = "L15"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 346, column 14.")
...
L16(self) == /\ pc[self] = "L16"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 350, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Aterminated"]
             /\ UNCHANGED << procs, channels, currentState, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
                             evtRecv_r, initialState_r, finalState_r, 
...
L19(self) == /\ pc[self] = "L19"
             ...
             /\ UNCHANGED << procs, currentState, evtRecv_, initialState_, 
                             finalState_, newState_, noChannel_, evtRecv_r, 
                             initialState_r, finalState_r, newState_r, 
                             noChannel_r, initialState_re, finalState_re, 
...
L24(self) == /\ pc[self] = "L24"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AIdle)), 
                       "Failure of assertion at line 467, column 14.")
...
L28(self) == /\ pc[self] = "L28"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 491, column 14.")
             /\ newState_re' = [newState_re EXCEPT ![self] = idx_state_BEstablished]
...
L29(self) == /\ pc[self] = "L29"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 501, column 14.")
...
L30(self) == /\ pc[self] = "L30"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 505, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Bterminated"]
             /\ UNCHANGED << procs, channels, currentState, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
                             evtRecv_r, initialState_r, finalState_r, 
