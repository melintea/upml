...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "eb102433" /\ chksum(tla) = "ae53ae7d")
...
\* Process variable evtRecv of process region_r20 at line 249 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r20 at line 250 col 5 changed to initialState_r
\* Process variable finalState of process region_r20 at line 251 col 5 changed to finalState_r
\* Process variable newState of process region_r20 at line 252 col 5 changed to newState_r
\* Process variable noChannel of process region_r20 at line 253 col 5 changed to noChannel_r
\* Process variable evtRecv of process region_r42 at line 412 col 5 changed to evtRecv_re
\* Process variable initialState of process region_r42 at line 413 col 5 changed to initialState_re
\* Process variable finalState of process region_r42 at line 414 col 5 changed to finalState_re
\* Process variable newState of process region_r42 at line 415 col 5 changed to newState_re
\* Process variable noChannel of process region_r42 at line 416 col 5 changed to noChannel_re
...
L13(self) == /\ pc[self] = "L13"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 353, column 14.")
             /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_AInitiated]
             /\ pc' = [pc EXCEPT ![self] = "body_AInitiated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
...
L14(self) == /\ pc[self] = "L14"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 366, column 14.")
...
L15(self) == /\ pc[self] = "L15"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 376, column 14.")
...
L16(self) == /\ pc[self] = "L16"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 380, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Aterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
L24(self) == /\ pc[self] = "L24"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AIdle)), 
                       "Failure of assertion at line 500, column 14.")
...
L28(self) == /\ pc[self] = "L28"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 525, column 14.")
             /\ newState_re' = [newState_re EXCEPT ![self] = idx_state_BEstablished]
...
L29(self) == /\ pc[self] = "L29"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 535, column 14.")
...
L30(self) == /\ pc[self] = "L30"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 539, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Bterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
