...
variables
    ...
    stateTransitions = { "t28", "t21", "t24", "t25", "t49", "t50", "t43", "t46", "t6", "t12", "t9" };
...
loop_AliceDial: skip;
    ...
    \* either {
        ...
        \*     (F:'';L:6;C:1) AliceDial --> BobPickup NullEvent[currentState:Alice,==,state:AIdle,]/send,event:Dial,to,state:Alice, (t6)
        await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r20] =idx_state_AIdle);L34:send_event(idx_region_r20, idx_event_Dial, idx_state_AliceDial, idx_state_Alice); 
...
body_AliceHangup: skip;
    ...
    \* either {
        ...
        \*     (F:'';L:12;C:1) AliceHangup --> CallEnded NullEvent[currentState:Alice,==,state:AEstablished,]/send,event:Hangup,to,state:Alice, (t12)
        await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r20] =idx_state_AEstablished);L37:send_event(idx_region_r20, idx_event_Hangup, idx_state_AliceHangup, idx_state_Alice); 
...
body_BobPickup: skip;
    ...
    \* either {
        ...
        \*     (F:'';L:9;C:1) BobPickup --> AliceHangup NullEvent[currentState:Bob,==,state:BInitiated,]/send,event:Pickup,to,state:Bob, (t9)
        await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r42] =idx_state_BInitiated);L40:send_event(idx_region_r42, idx_event_Pickup, idx_state_BobPickup, idx_state_Bob); 
...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "739d6d33" /\ chksum(tla) = "2a4dd09d")
\* Process variable evtRecv of process region_r3 at line 184 col 5 changed to evtRecv_
\* Process variable initialState of process region_r3 at line 185 col 5 changed to initialState_
\* Process variable finalState of process region_r3 at line 186 col 5 changed to finalState_
\* Process variable newState of process region_r3 at line 187 col 5 changed to newState_
\* Process variable noChannel of process region_r3 at line 188 col 5 changed to noChannel_
\* Process variable evtRecv of process region_r20 at line 250 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r20 at line 251 col 5 changed to initialState_r
\* Process variable finalState of process region_r20 at line 252 col 5 changed to finalState_r
\* Process variable newState of process region_r20 at line 253 col 5 changed to newState_r
\* Process variable noChannel of process region_r20 at line 254 col 5 changed to noChannel_r
\* Process variable evtRecv of process region_r42 at line 413 col 5 changed to evtRecv_re
\* Process variable initialState of process region_r42 at line 414 col 5 changed to initialState_re
\* Process variable finalState of process region_r42 at line 415 col 5 changed to finalState_re
\* Process variable newState of process region_r42 at line 416 col 5 changed to newState_re
\* Process variable noChannel of process region_r42 at line 417 col 5 changed to noChannel_re
...
L8(self) == /\ pc[self] = "L8"
            ...
            /\ visitedTransitions' = [visitedTransitions EXCEPT !["t28"] = TRUE]
...
L12(self) == /\ pc[self] = "L12"
             /\ \/ /\ (evtRecv_r[self] = idx_event_1xx)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT !["t24"] = TRUE]
...
L13(self) == /\ pc[self] = "L13"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 354, column 14.")
             /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_AInitiated]
             /\ pc' = [pc EXCEPT ![self] = "body_AInitiated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
...
L15(self) == /\ pc[self] = "L15"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 377, column 14.")
...
L24(self) == /\ pc[self] = "L24"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AIdle)), 
                       "Failure of assertion at line 502, column 10.")
...
L29(self) == /\ pc[self] = "L29"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 536, column 14.")
