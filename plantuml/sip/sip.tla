...
variables
    ...
    maxEvents = -20;  \* limit the number of UML events in the run
...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "a2362e7d" /\ chksum(tla) = "618e4353")
...
\* Process variable evtRecv of process region_r20 at line 248 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r20 at line 249 col 5 changed to initialState_r
\* Process variable finalState of process region_r20 at line 250 col 5 changed to finalState_r
\* Process variable newState of process region_r20 at line 251 col 5 changed to newState_r
\* Process variable noChannel of process region_r20 at line 252 col 5 changed to noChannel_r
\* Process variable evtRecv of process region_r42 at line 407 col 5 changed to evtRecv_re
\* Process variable initialState of process region_r42 at line 408 col 5 changed to initialState_re
\* Process variable finalState of process region_r42 at line 409 col 5 changed to finalState_re
\* Process variable newState of process region_r42 at line 410 col 5 changed to newState_re
\* Process variable noChannel of process region_r42 at line 411 col 5 changed to noChannel_re
...
vars == << procs, channels, currentState, stateTransitions, 
           visitedTransitions, maxEvents, pc, evtRecv_, initialState_, 
...
entry_Alice(self) == /\ pc[self] = "entry_Alice"
                     ...
                     /\ UNCHANGED << procs, channels, stateTransitions, 
                                     visitedTransitions, maxEvents, evtRecv_, 
...
body_Alice(self) == /\ pc[self] = "body_Alice"
                    ...
                    /\ UNCHANGED << procs, channels, currentState, 
                                    ...
                                    maxEvents, initialState_, finalState_, 
...
L1(self) == /\ pc[self] = "L1"
            ...
            /\ UNCHANGED << procs, currentState, stateTransitions, 
                            visitedTransitions, maxEvents, initialState_, 
...
body_AIdle(self) == /\ pc[self] = "body_AIdle"
                    ...
                    /\ UNCHANGED << procs, channels, currentState, 
                                    stateTransitions, visitedTransitions, 
                                    maxEvents, evtRecv_, initialState_, 
...
L9(self) == /\ pc[self] = "L9"
            /\ Assert(((currentState[idx_region_r20] /=idx_state_BIdle)), 
                      "Failure of assertion at line 325, column 13.")
...
L13(self) == /\ pc[self] = "L13"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 349, column 14.")
             /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_AInitiated]
             /\ pc' = [pc EXCEPT ![self] = "body_AInitiated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxEvents, evtRecv_, 
...
L14(self) == /\ pc[self] = "L14"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 361, column 14.")
...
L16(self) == /\ pc[self] = "L16"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 375, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Aterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
L24(self) == /\ pc[self] = "L24"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AIdle)), 
                       "Failure of assertion at line 492, column 14.")
...
L28(self) == /\ pc[self] = "L28"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 516, column 14.")
             /\ newState_re' = [newState_re EXCEPT ![self] = idx_state_BEstablished]
...
L29(self) == /\ pc[self] = "L29"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 526, column 14.")
