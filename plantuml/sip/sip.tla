...
idx_transition_t28 == 1
idx_transition_t21 == 2
idx_transition_t24 == 3
idx_transition_t25 == 4
idx_transition_t49 == 5
idx_transition_t50 == 6
idx_transition_t43 == 7
idx_transition_t46 == 8
idx_transition_t6 == 9
idx_transition_t12 == 10
idx_transition_t9 == 11
...
variables
    ...
    procs = { idx_region_r20, idx_region_r3, idx_region_r4, idx_region_r42 };
    channels = [p \in procs |-> <<>>];
    currentState = [p \in procs |-> idx_Unknown];
    stateTransitions = { idx_transition_t28, idx_transition_t21, idx_transition_t24, idx_transition_t25, idx_transition_t49, idx_transition_t50, idx_transition_t43, idx_transition_t46, idx_transition_t6, idx_transition_t12, idx_transition_t9 };
...
define {
    ...
    UmlInvariants == 
        ...
        /\ []((currentState[idx_region_r20] /=idx_state_Bterminated))

        \*     (F:'';L:57;C:3) BInitiated:invariant: (,currentState:Bob,!=,state:Aterminated,), (a57)

        /\ []((currentState[idx_region_r42] /=idx_state_Aterminated))
}; 
...
variables
    ...
    noChannel = FALSE; 
{
proc_body_idx_region_r20: currentState[self] := initialState;
...
loop_AIdle: skip;
    ...
    \* either {
            ...
            visitedTransitions[idx_transition_t21] := TRUE;
...
entry_AEstablished: skip;
    ...
    L6:send_event(idx_region_r42, idx_event_ACK, idx_state_AEstablished, idx_state_Bob); 
...
body_AEstablished: skip;
    ...
    \* either {
            ...
            visitedTransitions[idx_transition_t28] := TRUE;
...
entry_AInitiated: skip;
    currentState[self] := newState;
        ...
        L9: assert((currentState[idx_region_r20] /=idx_state_BIdle));

    \*     (F:'';L:23;C:3) AInitiated:entry: send,event:INVITE,to,state:Bob, (a23)

    L10:send_event(idx_region_r42, idx_event_INVITE, idx_state_AInitiated, idx_state_Bob); 
...
body_AInitiated: skip;
    ...
    either {
            ...
            visitedTransitions[idx_transition_t24] := TRUE;
        \*     (F:'';L:35;C:3) AInitiated:postcondition: (,currentState:Alice,!=,state:BInitiated,), (a35)

        L13: assert((currentState[idx_region_r20] /=idx_state_BInitiated));
            ...
            visitedTransitions[idx_transition_t25] := TRUE;
        \*     (F:'';L:35;C:3) AInitiated:postcondition: (,currentState:Alice,!=,state:BInitiated,), (a35)

        L14: assert((currentState[idx_region_r20] /=idx_state_BInitiated));
    ...
    \*]transitions idx_state_AInitiated
        ...
        L15: assert((currentState[idx_region_r20] /=idx_state_BInitiated));

        \*     (F:'';L:35;C:3) AInitiated:postcondition: (,currentState:Alice,!=,state:BInitiated,), (a35)

        L16: assert((currentState[idx_region_r20] /=idx_state_BInitiated));
...
entry_Aterminated: skip;
    ...
    L17:send_event(idx_region_r42, idx_event_BYE, idx_state_Aterminated, idx_state_Bob); 
...
variables
    ...
    noChannel = FALSE; 
{
proc_body_idx_region_r42: currentState[self] := initialState;
...
loop_BIdle: skip;
    ...
    \* either {
            ...
            visitedTransitions[idx_transition_t43] := TRUE;
...
entry_BEstablished: skip;
    ...
    L21:send_event(idx_region_r20, idx_event_2xx, idx_state_BEstablished, idx_state_Alice); 
...
body_BEstablished: skip;
    ...
    either {
            ...
            visitedTransitions[idx_transition_t49] := TRUE;
            ...
            visitedTransitions[idx_transition_t50] := TRUE;
...
entry_BInitiated: skip;
    currentState[self] := newState;
        ...
        L24: assert((currentState[idx_region_r42] /=idx_state_AIdle));

    \*     (F:'';L:45;C:3) BInitiated:entry: send,event:1xx,to,state:Alice, (a45)

    L25:send_event(idx_region_r20, idx_event_1xx, idx_state_BInitiated, idx_state_Alice); 
...
body_BInitiated: skip;
    ...
    \* either {
            ...
            visitedTransitions[idx_transition_t46] := TRUE;
        \*     (F:'';L:56;C:3) BInitiated:postcondition: (,currentState:Bob,!=,state:AInitiated,), (a56)

        L28: assert((currentState[idx_region_r42] /=idx_state_AInitiated));
    ...
    \*]transitions idx_state_BInitiated
        ...
        L29: assert((currentState[idx_region_r42] /=idx_state_AInitiated));

        \*     (F:'';L:56;C:3) BInitiated:postcondition: (,currentState:Bob,!=,state:AInitiated,), (a56)

        L30: assert((currentState[idx_region_r42] /=idx_state_AInitiated));
...
loop_AliceDial: skip;
    ...
    \* either {
            ...
            await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r20] =idx_state_AIdle);
            L34:send_event(idx_region_r20, idx_event_Dial, idx_state_AliceDial, idx_state_Alice); 

            visitedTransitions[idx_transition_t6] := TRUE;
...
body_AliceHangup: skip;
    ...
    \* either {
            ...
            await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r20] =idx_state_AEstablished);
            L37:send_event(idx_region_r20, idx_event_Hangup, idx_state_AliceHangup, idx_state_Alice); 

            visitedTransitions[idx_transition_t12] := TRUE;
...
body_BobPickup: skip;
    ...
    \* either {
            ...
            await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r42] =idx_state_BInitiated);
            L40:send_event(idx_region_r42, idx_event_Pickup, idx_state_BobPickup, idx_state_Bob); 

            visitedTransitions[idx_transition_t9] := TRUE;
...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "b5aadb7b" /\ chksum(tla) = "c019c025")
\* Process variable evtRecv of process region_r3 at line 198 col 5 changed to evtRecv_
\* Process variable initialState of process region_r3 at line 199 col 5 changed to initialState_
\* Process variable finalState of process region_r3 at line 200 col 5 changed to finalState_
\* Process variable newState of process region_r3 at line 201 col 5 changed to newState_
\* Process variable noChannel of process region_r3 at line 202 col 5 changed to noChannel_
\* Process variable evtRecv of process region_r20 at line 261 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r20 at line 262 col 5 changed to initialState_r
\* Process variable finalState of process region_r20 at line 263 col 5 changed to finalState_r
\* Process variable newState of process region_r20 at line 264 col 5 changed to newState_r
\* Process variable noChannel of process region_r20 at line 265 col 5 changed to noChannel_r
\* Process variable evtRecv of process region_r42 at line 424 col 5 changed to evtRecv_re
\* Process variable initialState of process region_r42 at line 425 col 5 changed to initialState_re
\* Process variable finalState of process region_r42 at line 426 col 5 changed to finalState_re
\* Process variable newState of process region_r42 at line 427 col 5 changed to newState_re
\* Process variable noChannel of process region_r42 at line 428 col 5 changed to noChannel_re
...
L5(self) == /\ pc[self] = "L5"
            ...
            /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t21] = TRUE]
...
L8(self) == /\ pc[self] = "L8"
            ...
            /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t28] = TRUE]
...
L9(self) == /\ pc[self] = "L9"
            /\ Assert(((currentState[idx_region_r20] /=idx_state_BIdle)), 
...
L12(self) == /\ pc[self] = "L12"
             /\ \/ /\ (evtRecv_r[self] = idx_event_1xx)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t24] = TRUE]
                   /\ pc' = [pc EXCEPT ![self] = "L13"]
                \/ /\ (evtRecv_r[self] = idx_event_2xx)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t25] = TRUE]
...
L13(self) == /\ pc[self] = "L13"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 365, column 14.")
             /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_AInitiated]
             /\ pc' = [pc EXCEPT ![self] = "body_AInitiated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
...
L14(self) == /\ pc[self] = "L14"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 378, column 14.")
...
L15(self) == /\ pc[self] = "L15"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 388, column 14.")
...
L16(self) == /\ pc[self] = "L16"
             /\ Assert(((currentState[idx_region_r20] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 392, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Aterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
L20(self) == /\ pc[self] = "L20"
             ...
             /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t43] = TRUE]
...
L23(self) == /\ pc[self] = "L23"
             /\ \/ /\ (evtRecv_re[self] = idx_event_ACK)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t49] = TRUE]
                   /\ newState_re' = [newState_re EXCEPT ![self] = idx_state_BEstablished]
                   /\ pc' = [pc EXCEPT ![self] = "body_BEstablished"]
                \/ /\ (evtRecv_re[self] = idx_event_BYE)
                   /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t50] = TRUE]
...
L24(self) == /\ pc[self] = "L24"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AIdle)), 
                       "Failure of assertion at line 512, column 14.")
...
L27(self) == /\ pc[self] = "L27"
             ...
             /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t46] = TRUE]
...
L28(self) == /\ pc[self] = "L28"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 537, column 14.")
             /\ newState_re' = [newState_re EXCEPT ![self] = idx_state_BEstablished]
...
L29(self) == /\ pc[self] = "L29"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 547, column 14.")
...
L30(self) == /\ pc[self] = "L30"
             /\ Assert(((currentState[idx_region_r42] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 551, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Bterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
L33(self) == /\ pc[self] = "L33"
             /\ (evtRecv[self] = idx_event_NullEvent /\ currentState[idx_region_r20] =idx_state_AIdle)
...
L34(self) == /\ pc[self] = "L34"
             ...
             /\ maxUmlEvents' = maxUmlEvents + 1
             /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t6] = TRUE]
...
L36(self) == /\ pc[self] = "L36"
             /\ (evtRecv[self] = idx_event_NullEvent /\ currentState[idx_region_r20] =idx_state_AEstablished)
...
L37(self) == /\ pc[self] = "L37"
             ...
             /\ maxUmlEvents' = maxUmlEvents + 1
             /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t12] = TRUE]
...
L39(self) == /\ pc[self] = "L39"
             /\ (evtRecv[self] = idx_event_NullEvent /\ currentState[idx_region_r42] =idx_state_BInitiated)
...
L40(self) == /\ pc[self] = "L40"
             ...
             /\ maxUmlEvents' = maxUmlEvents + 1
             /\ visitedTransitions' = [visitedTransitions EXCEPT ![idx_transition_t9] = TRUE]
