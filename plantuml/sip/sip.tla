/*
/home/amelinte/work/github/upml/src/upml --in /home/amelinte/work/github/upml/plantuml/sip/sip.plantuml --backend tla --out ../plantuml/sip/sip.tla 
*/
/*
   Generated by UPML v0.07
   Thu Apr  3 09:05:59 2025
    ...
    machine sip {
        ...
        -- r3 _ownedByState:m1 {
            (F:'';L:21;C:1)
            state Alice final:0;initial:0;_superState:m1;_ownedByRegion:r3 {
                (F:'';L:22;C:3)
                -- r22 _ownedByState:Alice {
                    (F:'';L:0;C:0)
                    state AEstablished final:0;initial:0;_superState:Alice;_ownedByRegion:r22 {
                        (F:'';L:30;C:3) AEstablished --> Aterminated Hangup[]/ (t30)
                        (F:'';L:29;C:3) AEstablished:entry: send,event:ACK,to,state:Bob, (a29)
                    } AEstablished
                    (F:'';L:0;C:0)
                    state AIdle final:0;initial:1;_superState:Alice;_ownedByRegion:r22 {
                        (F:'';L:23;C:3) AIdle --> AInitiated Dial[]/ (t23)
                    } AIdle
                    (F:'';L:0;C:0)
                    state AInitiated final:0;initial:0;_superState:Alice;_ownedByRegion:r22 {
                    ...
                    (F:'';L:0;C:0)
                    state Aterminated final:1;initial:0;_superState:Alice;_ownedByRegion:r22 {
                        (F:'';L:32;C:3) Aterminated:entry: send,event:BYE,to,state:Bob, (a32)
                    } Aterminated
                } r22
            } Alice
            (F:'';L:43;C:1)
            state Bob final:0;initial:0;_superState:m1;_ownedByRegion:r3 {
                (F:'';L:44;C:3)
                -- r44 _ownedByState:Bob {
                    (F:'';L:0;C:0)
                    state BEstablished final:0;initial:0;_superState:Bob;_ownedByRegion:r44 {
                    ...
                    (F:'';L:0;C:0)
                    state BIdle final:0;initial:1;_superState:Bob;_ownedByRegion:r44 {
                        (F:'';L:45;C:3) BIdle --> BInitiated INVITE[]/ (t45)
                    } BIdle
                    (F:'';L:0;C:0)
                    state BInitiated final:0;initial:0;_superState:Bob;_ownedByRegion:r44 {
                    ...
                    (F:'';L:0;C:0)
                    state Bterminated final:1;initial:0;_superState:Bob;_ownedByRegion:r44 {
                    } Bterminated
                } r44
            } Bob
            (F:'';L:3;C:1)
            state ClosedSystemEnvironment final:0;initial:0;_superState:m1;_ownedByRegion:r3 {
                ...
                (F:'';L:4;C:1)
                -- r4 _ownedByState:ClosedSystemEnvironment {
                    (F:'';L:0;C:0)
                    state AliceDial final:0;initial:1;_superState:ClosedSystemEnvironment;_ownedByRegion:r4 {
                        (F:'';L:6;C:1) AliceDial --> BobPickup NullEvent[state:Alice:currentState,==,state:AIdle,]/send,event:Dial,to,state:Alice, (t6)
                        noInboundEvents,
                    } AliceDial
                    (F:'';L:0;C:0)
                    state AliceHangup final:0;initial:0;_superState:ClosedSystemEnvironment;_ownedByRegion:r4 {
                    ...
                    (F:'';L:0;C:0)
                    state BobPickup final:0;initial:0;_superState:ClosedSystemEnvironment;_ownedByRegion:r4 {
                        (F:'';L:9;C:1) BobPickup --> AliceHangup NullEvent[state:Bob:currentState,==,state:BInitiated,]/send,event:Pickup,to,state:Bob, (t9)
                        noInboundEvents,
                    } BobPickup
                    (F:'';L:0;C:0)
                    state CallEnded final:1;initial:0;_superState:ClosedSystemEnvironment;_ownedByRegion:r4 {
                        noInboundEvents,
                    } CallEnded
                } r4
...
loop_AliceDial: skip;    
    ...
    \* either {    
        ...
        \*     (F:'';L:6;C:1) AliceDial --> BobPickup NullEvent[state:Alice:currentState,==,state:AIdle,]/send,event:Dial,to,state:Alice, (t6)
        await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r22] =idx_state_AIdle);
        \*     (F:'';L:0;C:0) idx_state_AliceDial:send: send,event:Dial,to,state:Alice, (a6)
        L34:send_event(idx_region_r22, idx_event_Dial, idx_state_AliceDial, idx_state_Alice); 
...
body_AliceHangup: skip;    
    ...
    \* either {    
        ...
        \*     (F:'';L:12;C:1) AliceHangup --> CallEnded NullEvent[state:Alice:currentState,==,state:AEstablished,]/send,event:Hangup,to,state:Alice, (t12)
        await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r22] =idx_state_AEstablished);
        \*     (F:'';L:0;C:0) idx_state_AliceHangup:send: send,event:Hangup,to,state:Alice, (a12)
        L37:send_event(idx_region_r22, idx_event_Hangup, idx_state_AliceHangup, idx_state_Alice); 
...
body_BobPickup: skip;    
    ...
    \* either {    
        ...
        \*     (F:'';L:9;C:1) BobPickup --> AliceHangup NullEvent[state:Bob:currentState,==,state:BInitiated,]/send,event:Pickup,to,state:Bob, (t9)
        await (evtRecv = idx_event_NullEvent /\ currentState[idx_region_r44] =idx_state_BInitiated);
        \*     (F:'';L:0;C:0) idx_state_BobPickup:send: send,event:Pickup,to,state:Bob, (a9)
        L40:send_event(idx_region_r44, idx_event_Pickup, idx_state_BobPickup, idx_state_Bob); 
...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "a2f04f61" /\ chksum(tla) = "3ff40841")
\* Process variable evtRecv of process region_r3 at line 188 col 5 changed to evtRecv_
\* Process variable initialState of process region_r3 at line 189 col 5 changed to initialState_
\* Process variable finalState of process region_r3 at line 190 col 5 changed to finalState_
\* Process variable newState of process region_r3 at line 191 col 5 changed to newState_
\* Process variable noChannel of process region_r3 at line 192 col 5 changed to noChannel_
\* Process variable evtRecv of process region_r22 at line 254 col 5 changed to evtRecv_r
\* Process variable initialState of process region_r22 at line 255 col 5 changed to initialState_r
\* Process variable finalState of process region_r22 at line 256 col 5 changed to finalState_r
\* Process variable newState of process region_r22 at line 257 col 5 changed to newState_r
\* Process variable noChannel of process region_r22 at line 258 col 5 changed to noChannel_r
\* Process variable evtRecv of process region_r44 at line 412 col 5 changed to evtRecv_re
\* Process variable initialState of process region_r44 at line 413 col 5 changed to initialState_re
\* Process variable finalState of process region_r44 at line 414 col 5 changed to finalState_re
\* Process variable newState of process region_r44 at line 415 col 5 changed to newState_re
\* Process variable noChannel of process region_r44 at line 416 col 5 changed to noChannel_re
...
ProcSet == ({idx_region_r3}) \cup ({idx_region_r22}) \cup ({idx_region_r44}) \cup ({idx_region_r4})
...
Init == (* Global variables *)
        ...
        (* Process region_r22 *)
        /\ evtRecv_r = [self \in {idx_region_r22} |-> idx_Unknown]
        /\ initialState_r = [self \in {idx_region_r22} |-> idx_state_AIdle]
        /\ finalState_r = [self \in {idx_region_r22} |-> idx_state_Aterminated]
        /\ newState_r = [self \in {idx_region_r22} |-> initialState_r[self]]
        /\ noChannel_r = [self \in {idx_region_r22} |-> FALSE]
        (* Process region_r44 *)
        /\ evtRecv_re = [self \in {idx_region_r44} |-> idx_Unknown]
        /\ initialState_re = [self \in {idx_region_r44} |-> idx_state_BIdle]
        /\ finalState_re = [self \in {idx_region_r44} |-> idx_state_Bterminated]
        /\ newState_re = [self \in {idx_region_r44} |-> initialState_re[self]]
        /\ noChannel_re = [self \in {idx_region_r44} |-> FALSE]
        (* Process region_r4 *)
        ...
        /\ pc = [self \in ProcSet |-> CASE self \in {idx_region_r3} -> "proc_body_idx_region_r3"
                                        ...
                                        [] self \in {idx_region_r44} -> "proc_body_idx_region_r44"
...
region_r3(self) == proc_body_idx_region_r3(self) \/ entry_Alice(self)
                      \/ body_Alice(self) \/ L1(self) \/ entry_Bob(self)
                      \/ body_Bob(self) \/ L2(self)
...
L6(self) == /\ pc[self] = "L6"
            /\ PrintT(<<"P:", idx_state_AEstablished, "o->", idx_event_ACK, idx_region_r44, " > P:", idx_state_Bob>>)
            /\ channels' = [channels EXCEPT ![idx_region_r44] = Append(@, idx_event_ACK)]
            /\ maxUmlEvents' = maxUmlEvents + 1
...
L9(self) == /\ pc[self] = "L9"
            /\ Assert(((currentState[idx_region_r22] /=idx_state_BIdle)), 
...
L10(self) == /\ pc[self] = "L10"
             /\ PrintT(<<"P:", idx_state_AInitiated, "o->", idx_event_INVITE, idx_region_r44, " > P:", idx_state_Bob>>)
             /\ channels' = [channels EXCEPT ![idx_region_r44] = Append(@, idx_event_INVITE)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
L13(self) == /\ pc[self] = "L13"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 357, column 14.")
             /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_AInitiated]
             /\ pc' = [pc EXCEPT ![self] = "body_AInitiated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
...
L14(self) == /\ pc[self] = "L14"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 369, column 14.")
...
L15(self) == /\ pc[self] = "L15"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 378, column 10.")
...
L17(self) == /\ pc[self] = "L17"
             /\ PrintT(<<"P:", idx_state_Aterminated, "o->", idx_event_BYE, idx_region_r44, " > P:", idx_state_Bob>>)
             /\ channels' = [channels EXCEPT ![idx_region_r44] = Append(@, idx_event_BYE)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
region_r22(self) == proc_body_idx_region_r22(self) \/ entry_AIdle(self)
                       \/ body_AIdle(self) \/ loop_AIdle(self) \/ L4(self)
                       \/ L5(self) \/ entry_AEstablished(self) \/ L6(self)
                       \/ body_AEstablished(self) \/ L7(self) \/ L8(self)
                       \/ entry_AInitiated(self) \/ L9(self) \/ L10(self)
                       \/ body_AInitiated(self) \/ L11(self) \/ L12(self)
...
proc_body_idx_region_r44(self) == /\ pc[self] = "proc_body_idx_region_r44"
...
L21(self) == /\ pc[self] = "L21"
             /\ PrintT(<<"P:", idx_state_BEstablished, "o->", idx_event_2xx, idx_region_r22, " > P:", idx_state_Alice>>)
             /\ channels' = [channels EXCEPT ![idx_region_r22] = Append(@, idx_event_2xx)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
L24(self) == /\ pc[self] = "L24"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AIdle)), 
                       "Failure of assertion at line 501, column 10.")
...
L25(self) == /\ pc[self] = "L25"
             /\ PrintT(<<"P:", idx_state_BInitiated, "o->", idx_event_1xx, idx_region_r22, " > P:", idx_state_Alice>>)
             /\ channels' = [channels EXCEPT ![idx_region_r22] = Append(@, idx_event_1xx)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
L28(self) == /\ pc[self] = "L28"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 524, column 14.")
             /\ newState_re' = [newState_re EXCEPT ![self] = idx_state_BEstablished]
...
L29(self) == /\ pc[self] = "L29"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 533, column 10.")
...
L30(self) == /\ pc[self] = "L30"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 536, column 10.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Bterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
region_r44(self) == proc_body_idx_region_r44(self) \/ entry_BIdle(self)
                       \/ body_BIdle(self) \/ loop_BIdle(self) \/ L19(self)
                       \/ L20(self) \/ entry_BEstablished(self)
                       \/ L21(self) \/ body_BEstablished(self) \/ L22(self)
                       \/ L23(self) \/ entry_BInitiated(self) \/ L24(self)
                       \/ L25(self) \/ body_BInitiated(self) \/ L26(self)
                       \/ L27(self) \/ L28(self) \/ L29(self) \/ L30(self)
...
L33(self) == /\ pc[self] = "L33"
             /\ (evtRecv[self] = idx_event_NullEvent /\ currentState[idx_region_r22] =idx_state_AIdle)
...
L34(self) == /\ pc[self] = "L34"
             /\ PrintT(<<"P:", idx_state_AliceDial, "o->", idx_event_Dial, idx_region_r22, " > P:", idx_state_Alice>>)
             /\ channels' = [channels EXCEPT ![idx_region_r22] = Append(@, idx_event_Dial)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
L36(self) == /\ pc[self] = "L36"
             /\ (evtRecv[self] = idx_event_NullEvent /\ currentState[idx_region_r22] =idx_state_AEstablished)
...
L37(self) == /\ pc[self] = "L37"
             /\ PrintT(<<"P:", idx_state_AliceHangup, "o->", idx_event_Hangup, idx_region_r22, " > P:", idx_state_Alice>>)
             /\ channels' = [channels EXCEPT ![idx_region_r22] = Append(@, idx_event_Hangup)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
L39(self) == /\ pc[self] = "L39"
             /\ (evtRecv[self] = idx_event_NullEvent /\ currentState[idx_region_r44] =idx_state_BInitiated)
...
L40(self) == /\ pc[self] = "L40"
             /\ PrintT(<<"P:", idx_state_BobPickup, "o->", idx_event_Pickup, idx_region_r44, " > P:", idx_state_Bob>>)
             /\ channels' = [channels EXCEPT ![idx_region_r44] = Append(@, idx_event_Pickup)]
             /\ maxUmlEvents' = maxUmlEvents + 1
...
Next == (\E self \in {idx_region_r3}: region_r3(self))
           ...
           \/ (\E self \in {idx_region_r44}: region_r44(self))
...
Spec == /\ Init /\ [][Next]_vars
        ...
        /\ \A self \in {idx_region_r44} : SF_vars(region_r44(self))
