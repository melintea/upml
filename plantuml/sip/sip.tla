...
**********************************************************************)
\* BEGIN TRANSLATION (chksum(pcal) = "f9513547" /\ chksum(tla) = "87a50a07")
\* Label entry_ClosedSystemEnvironment of process region_r3 at line 234 col 32 changed to entry_ClosedSystemEnvironment_
\* Label body_ClosedSystemEnvironment of process region_r3 at line 239 col 31 changed to body_ClosedSystemEnvironment_
...
\* Process variable evtRecv of process region_r44 at line 417 col 5 changed to evtRecv_re
\* Process variable initialState of process region_r44 at line 418 col 5 changed to initialState_re
\* Process variable finalState of process region_r44 at line 419 col 5 changed to finalState_re
\* Process variable newState of process region_r44 at line 420 col 5 changed to newState_re
\* Process variable noChannel of process region_r44 at line 421 col 5 changed to noChannel_re
...
body_Bob(self) == /\ pc[self] = "body_Bob"
                  ...
                  /\ IF noChannel_[self] = FALSE
                        THEN /\ pc' = [pc EXCEPT ![self] = "L2"]
                             /\ UNCHANGED evtRecv_
                        ELSE /\ evtRecv_' = [evtRecv_ EXCEPT ![self] = idx_event_NullEvent]
                             /\ pc' = [pc EXCEPT ![self] = "entry_ClosedSystemEnvironment_"]
                  /\ UNCHANGED << procs, channels, currentState, 
                                  stateTransitions, visitedTransitions, 
                                  maxUmlEvents, initialState_, finalState_, 
                                  newState_, noChannel_, evtRecv_r, 
...
entry_ClosedSystemEnvironment_(self) == /\ pc[self] = "entry_ClosedSystemEnvironment_"
                                        /\ TRUE
                                        /\ currentState' = [currentState EXCEPT ![self] = newState_[self]]
                                        /\ noChannel_' = [noChannel_ EXCEPT ![self] = TRUE]
                                        /\ pc' = [pc EXCEPT ![self] = "body_ClosedSystemEnvironment_"]
                                        /\ UNCHANGED << procs, channels, 
                                                        stateTransitions, 
                                                        visitedTransitions, 
                                                        maxUmlEvents, evtRecv_, 
...
body_ClosedSystemEnvironment_(self) == /\ pc[self] = "body_ClosedSystemEnvironment_"
                                       /\ TRUE
                                       /\ IF noChannel_[self] = FALSE
...
region_r3(self) == proc_body_idx_region_r3(self) \/ entry_Alice(self)
                      ...
                      \/ entry_ClosedSystemEnvironment_(self)
                      \/ body_ClosedSystemEnvironment_(self) \/ L3(self)
...
L13(self) == /\ pc[self] = "L13"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 358, column 14.")
             /\ newState_r' = [newState_r EXCEPT ![self] = idx_state_AInitiated]
             /\ pc' = [pc EXCEPT ![self] = "body_AInitiated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
...
L14(self) == /\ pc[self] = "L14"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 371, column 14.")
...
L15(self) == /\ pc[self] = "L15"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 381, column 14.")
...
L16(self) == /\ pc[self] = "L16"
             /\ Assert(((currentState[idx_region_r22] /=idx_state_BInitiated)), 
                       "Failure of assertion at line 385, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Aterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
L24(self) == /\ pc[self] = "L24"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AIdle)), 
                       "Failure of assertion at line 506, column 10.")
...
L28(self) == /\ pc[self] = "L28"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 530, column 14.")
             /\ newState_re' = [newState_re EXCEPT ![self] = idx_state_BEstablished]
...
L29(self) == /\ pc[self] = "L29"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 540, column 14.")
...
L30(self) == /\ pc[self] = "L30"
             /\ Assert(((currentState[idx_region_r44] /=idx_state_AInitiated)), 
                       "Failure of assertion at line 544, column 14.")
             /\ pc' = [pc EXCEPT ![self] = "entry_Bterminated"]
             /\ UNCHANGED << procs, channels, currentState, stateTransitions, 
                             visitedTransitions, maxUmlEvents, evtRecv_, 
                             initialState_, finalState_, newState_, noChannel_, 
...
region_r4(self) == proc_body_idx_region_r4(self) \/ entry_AliceDial(self)
                      ...
                      \/ body_ClosedSystemEnvironment(self) \/ L41(self)
