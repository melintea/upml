...
#define PanSource	"switch.promela"
...
#define _nstates0	28	/* TestEnvironment */
#define minseq0	0
#define maxseq0	26
...
#define PTestEnvironment	((P0 *)_this)
typedef struct P0 { /* TestEnvironment */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
