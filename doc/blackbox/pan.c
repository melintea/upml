...
short src_ln0 [] = {
	  0,  16,  19,  19,  20,  20,  18,  22, 
	 22,  22,  25,  25,  26,  26,  24,  28, 
	 28,  28,  31,  31,  32,  32,  30,  34, 
	 34,  34,  42,  43,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "switch.promela", 1, 27 },
...
struct {
	...
	{ "c_code12", "terminate();" },
	{ "c_code11", "now.isLigtOn = is_light_on();" },
	{ "c_code10", "flip_wall_switch();" },
	{ "c_code9", "flip_lamp_switch();" },
	{ "c_code8", "now.isLigtOn = is_light_on();" },
	{ "c_code7", "flip_lamp_switch();" },
	{ "c_code6", "flip_wall_switch();" },
	{ "c_code5", "now.isLigtOn = is_light_on();" },
	{ "c_code4", "flip_wall_switch();" },
	{ "c_code3", "flip_lamp_switch();" },
	{ "c_code2", "initialize();" },
	{ "c_code1", "#include \"bindings.hpp\"\n\n#include <iostream>\n" },
	{ (char *) 0, "" }
};
...
{	int j = 0, h = now._nr_pr;
	...
	case 0:	/* TestEnvironment */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->flippedWall = 0;
#ifdef VAR_RANGES
		logval("TestEnvironment:flippedWall", ((P0 *)pptr(h))->flippedWall);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	case 1:
		...
		break;
	case 0:
		printf("local vars proc %d (TestEnvironment):\n", pid);
	printf("	bit    flippedWall:	%d\n", ((P0 *)pptr(pid))->flippedWall);
		break;
	}
}
void
